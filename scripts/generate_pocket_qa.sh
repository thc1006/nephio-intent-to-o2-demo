...
# Generate POCKET_QA.md
cat > "${RUNBOOK_DIR}/POCKET_QA.md" << 'EOF'
...
echo "✅ Generated ${RUNBOOK_DIR}/POCKET_QA.md"

# Validate markdown
if command -v markdownlint >/dev/null 2>&1; then
    echo "Running markdown lint..."
    markdownlint "${RUNBOOK_DIR}/POCKET_QA.md" --disable MD041 MD013 MD034 || true
fi

echo "=== Pocket Q&A generation complete ==="