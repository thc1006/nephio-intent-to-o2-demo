...
def create_app() -> Flask:
    ...
    def metrics():
        ...
        metrics_data = {
            ...
            "metadata": {"adapter_version": "1.0.0", "source": "job-query-adapter"},
        }
    ...
    def not_found(error):
        """Handle 404 errors."""
        logger.warning(
            "Endpoint not found", extra={"endpoint": error.description, "method": "GET"}
        )
    ...
    def internal_error(error):
        """Handle 500 errors."""
        logger.error(
            "Internal server error", extra={"error": str(error), "endpoint": "/metrics"}
        )
