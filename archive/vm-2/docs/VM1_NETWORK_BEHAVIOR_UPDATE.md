...
```bash
# 這些方式都能正常工作：
curl http://172.16.4.176:30090/health          # ✅ 成功
curl http://172.16.4.176:30090/metrics/api/v1/slo  # ✅ 成功
nc -z 172.16.4.176 30090                       # ✅ 成功
telnet 172.16.4.176 30090                      # ✅ 成功
```

### ❌ **不可用的連接方式**
```bash
# 這些方式會失敗：
ping 172.16.4.176                              # ❌ 失敗 (ICMP 被阻擋)
...
declare -A O2IMS_SITES=(
    ...
    [edge2]="http://172.16.4.176:31280/o2ims/measurement/v1/slo"  # 使用內網 IP
)
```
